...
from benchmarks.norm_gemv_multi import linear
from fast_moss.graphs import GraphedCallable
from fast_moss.loading import strict_precision

CONFIGS=[(0,128,64,2,8,16,1,1),(0,128,64,2,8,16,1,2),(0,128,64,2,8,16,1,4),
         (1,32,64,2,8,16,1,8),(1,64,64,2,8,16,1,4),(1,64,64,2,8,4,0,2),
         (1,128,128,1,0,4,0,2),(1,32,320,2,8,4,1,4)]
...
def test_multi_norm_gemv_exact_shared_lifetime(n,mode,cfg):
...
@torch.inference_mode()
def test_multi_norm_gemv_operand_and_shared_memory_guards():
    ...
    with pytest.raises(ValueError,match='configuration'):linear(x,w,g,b,1e-5,'none',(1,256,640,2,8,4,1,8))
