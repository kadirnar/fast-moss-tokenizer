...
def main():
    ...
    report={"scope":"full checkpoint, small regression corpus", "revision":REVISION,
            ...
            "quantizers":32,"norm_backend":a.norm_backend,"ffn_backend":a.ffn_backend,"projection_backend":a.projection_backend,"quantizer_backend":a.quantizer_backend,"matrix_backend":a.matrix_backend,"residual_backend":a.backend,"rope_backend":a.rope_backend,
