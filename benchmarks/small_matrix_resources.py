...
from fast_moss.small_matrices import CONFIGS,linear,_small_grouped,_small_parts,_small_reduce
...
def main():
    ...
    Path('results/small_matrix_resources.json').write_text(json.dumps(report,indent=2)+'\n')
