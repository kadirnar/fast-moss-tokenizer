...
def main():
    ...
    report={"scope":"full checkpoint, independent batch lane timelines", "revision":REVISION,
            ...
            "input":"seeded Gaussian amplitude .05 and its encoded tokens","quantizers":32,"batch":2,"results":{}}
    ...
    Path("results/full_parallel_fidelity.json").write_text(json.dumps(report,indent=2)+"\n")
