"""Audit the integrated single-CTA matrices compiler output with its production flags."""
import hashlib
import json
from pathlib import Path
import torch
from fast_moss.cuda_matrices import CONFIGS, SOURCE, _compile, _check, compiler
...
def main():
    ...
    report = {'scope': 'integrated single-CTA matrices compiler resource audit', 'revision': REVISION,
    ...
    Path('results/cta_tiled_resources.json').write_text(json.dumps(report, indent=2)+'\n')
