...
def kernel_summary(path,replays=5):
    ...
    small_names=['_small_gemv','_ffn_gemv','_small_fixed','_small_grouped','_small_parts','_small_reduce']
    ...
    return {'scope':'CUDA kernel events only, excludes memcpy and host time','replays':replays,
            ...
            'small_matrix_breakdown_scope':'Already included in groups.small_matrix; do not add again. _ffn_gemv includes its fused epilogue.',
