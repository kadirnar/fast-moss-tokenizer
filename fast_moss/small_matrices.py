...
CONFIGS = {
    (1, 768, 1280): ('gemv', 32, 1, 1, 4),
    (1, 1280, 768): ('gemv', 16, 2, 1, 32),
    (1, 1280, 1280): ('gemv', 16, 2, 1, 4),
    (1, 1280, 5120): ('gemv', 16, 2, 1, 32),
    (1, 3840, 1280): ('gemv', 8, 8, 1, 32),
    (1, 5120, 1280): ('gemv', 8, 8, 1, 32),
    (2, 640, 768): ('fixed', 2, 2, 1, 16),
    (2, 768, 640): ('fixed', 2, 1, 1, 4),
    (2, 768, 768): ('fixed', 2, 2, 1, 4),
    (2, 768, 3072): ('fixed', 2, 2, 1, 4),
    (2, 2304, 768): ('fixed', 2, 2, 1, 16),
    ...
    (16, 640, 768): ('fixed', 4, 4, 1, 4),
    (16, 768, 640): ('fixed', 4, 4, 1, 4),
    (16, 768, 768): ('fixed', 4, 4, 1, 4),
    (16, 768, 3072): ('fixed', 4, 4, 1, 4),
    (16, 2304, 768): ('fixed', 8, 4, 1, 4),
