"""Exact native 16-lane residual GEMV with asynchronous shared staging.

Owned dispatch selects one validated FFN contraction schedule. Copying native
FP32 words does not change the cyclic FMA chain or separately rounded epilogue.
"""
...
def linear(x,w,residual,scale,config=CONFIG,resources=False):
