"""Exact short-row FFN epilogues on existing native matrix schedules."""
import ctypes
import torch
import triton
import triton.language as tl
from triton.language.extra.cuda import libdevice
from .ffn import _mul,_add,math_library
from .normalization import compiler,_check
from .cuda_matrices import SOURCE as CUDA_SOURCE
from .wide_matrices import SOURCE as WIDE_SOURCE
